...
OCaml is an impure language, so analysis of side effects is necessary to determine when expressions can be safely removed as above. This is done using the following annotations on nodes in the IR tree:
